      ...
      <Card>
        ...
        <CardContent>
              ...
              {loading && logs.length === 0 ? (
                ...
                logs.map((log) => (
                  <TableRow key={log.id}>
                    ...
                    <TableCell>{log.schools?.name || 'N/A'}</TableCell>
                    <TableCell>{log.whatsapp_templates?.name || 'N/A'}</TableCell>
          ...
          <div className="flex justify-between items-center mt-4">
             ...
             <Button variant="outline" disabled={logs.length < 20} onClick={() => setPage(p => p + 1)}>Next</Button>
          </div>
        </CardContent>
      </Card>
    </div>
