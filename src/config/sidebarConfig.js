  ...
  super_admin: [
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: '⚙️ Admission Form Settings', path: '/super-admin/student-information/admission-form-settings' },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: '📊 Fee Dashboard', path: '/super-admin/fees-collection/fee-dashboard' },
        ...
        { title: '🏗️ Fee Structures', path: '/super-admin/fees-collection/fee-structures' },
        { title: '🧠 Smart Rules', path: '/super-admin/fees-collection/fee-rules' },
    ...
    },
    {
    ...
    },
     {
      ...
      icon: Briefcase,
      submenu: [
        { title: '� HR Dashboard', path: '/super-admin/human-resource/dashboard' },
        { title: '---', type: 'divider' },
        ...
        { title: '📢 Job Postings', path: '/super-admin/human-resource/recruitment/job-postings' },
        { title: '📋 Applications', path: '/super-admin/human-resource/recruitment/applications' },
        { title: '🗓️ Interviews', path: '/super-admin/human-resource/recruitment/interviews' },
        { title: '---', type: 'divider' },
        { title: '🚀 Onboarding', type: 'header' },
        { title: '✅ Checklists', path: '/super-admin/human-resource/onboarding/checklists' },
        { title: '👤 Employee Onboarding', path: '/super-admin/human-resource/onboarding/employee' },
        { title: '---', type: 'divider' },
        ...
        { title: '💳 Leave Balances', path: '/super-admin/human-resource/leave/balances' },
        { title: '📜 Leave Policies', path: '/super-admin/human-resource/leave/policies' },
        { title: '📆 Leave Calendar', path: '/super-admin/human-resource/leave/calendar' },
        { title: '---', type: 'divider' },
        { title: '💵 Payroll System', type: 'header' },
        { title: '🏗️ Salary Structure', path: '/super-admin/human-resource/payroll/salary-structure' },
        { title: '▶️ Payroll Run', path: '/super-admin/human-resource/payroll/run' },
        { title: '📃 Payslips', path: '/super-admin/human-resource/payroll/payslips' },
        { title: '💰 Loans Management', path: '/super-admin/human-resource/loans' },
      ],
    },
    {
      ...
      submenu: [
        ...
        { title: '🏷️ Categories', path: '/super-admin/task-management/categories' },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: '⚙️ Branch Settings', path: '/super-admin/multi-branch/settings' },
    ...
    },
    {
    ...
    },
     {
      ...
      submenu: [
          ...
          { title: '🛠️ Custom Builder', path: '/super-admin/reports/custom-builder' },
      ]
    },
    {
  ...
  accountant: [
    { title: 'Dashboard', icon: LayoutDashboard, path: ROUTES.ACCOUNTANT.DASHBOARD },
    {
      ...
      submenu: [
        ...
        { title: '🏗️ Fee Structures', path: '/accountant/fees-collection/fee-structures' },
        { title: '🧠 Smart Rules', path: '/accountant/fees-collection/fee-rules' },
