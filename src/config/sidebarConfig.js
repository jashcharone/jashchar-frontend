  ...
  super_admin: [
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Assign Fee Group', path: ROUTES.SUPER_ADMIN.ASSIGN_FEE_GROUP },
        { title: 'Fees Master (Legacy)', path: ROUTES.SUPER_ADMIN.FEES_MASTER },
        { title: 'Fees Group (Legacy)', path: ROUTES.SUPER_ADMIN.FEES_GROUP },
        // ── Fee Management ──
