  ...
  super_admin: [
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: '── Advanced Setup ──', path: '#super-admin-fees-advanced-setup', disabled: true },
        ...
        { title: '⏰ Late Fee Config', path: '/super-admin/fees-collection/late-fee-config', badge: 'NEW' },
        { title: '⏰ Late Fee Slabs', path: '/super-admin/fees-collection/late-fee-slabs', badge: 'NEW' },
        { title: '── Discount & EMI ──', path: '#super-admin-fees-discount-emi', disabled: true },
        ...
        { title: '── Payment Engine ──', path: '#super-admin-fees-payment-engine', disabled: true },
        { title: '💳 Payment Gateway Config', path: '/super-admin/fees-collection/payment-gateway-config', badge: 'NEW' },
        { title: '📦 Bulk Collection', path: '/super-admin/fees-collection/bulk-collection', badge: 'NEW' },
        { title: '🧾 Receipt Templates', path: '/super-admin/fees-collection/receipt-templates', badge: 'NEW' },
        { title: '📱 Digital Receipt', path: '/super-admin/fees-collection/digital-receipt', badge: 'NEW' },
        { title: '📲 UPI Payment', path: '/super-admin/fees-collection/upi-payment', badge: 'NEW' },
        { title: '── Analytics & Reports ──', path: '#super-admin-fees-analytics', disabled: true },
        { title: '📊 Analytics Dashboard', path: '/super-admin/fees-collection/analytics-dashboard', badge: 'NEW' },
        { title: '📅 Daily Collection', path: '/super-admin/fees-collection/daily-collection', badge: 'NEW' },
        { title: '⚠️ Outstanding Reports', path: '/super-admin/fees-collection/outstanding-reports', badge: 'NEW' },
        { title: '🏫 Class Wise Reports', path: '/super-admin/fees-collection/class-wise-reports', badge: 'NEW' },
        { title: '📈 Fee Type Analysis', path: '/super-admin/fees-collection/fee-type-analysis', badge: 'NEW' },
        { title: '💰 Payment Analytics', path: '/super-admin/fees-collection/payment-analytics', badge: 'NEW' },
        { title: '🚨 Defaulter Reports', path: '/super-admin/fees-collection/defaulter-reports', badge: 'NEW' },
        { title: '📊 Trend Analysis', path: '/super-admin/fees-collection/trend-analysis', badge: 'NEW' },
        { title: '⏰ Scheduled Reports', path: '/super-admin/fees-collection/scheduled-reports', badge: 'NEW' },
        { title: '🔧 Custom Report Builder', path: '/super-admin/fees-collection/custom-report-builder', badge: 'NEW' },
      ],
    },
    {
      title: 'Income',
