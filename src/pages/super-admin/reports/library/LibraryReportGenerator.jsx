...
import { fetchLibraryDataFromSupabase } from '../ReportGeneratorShared/reportQueries';
...
const LibraryReportGenerator = () => {
  ...
  const allTemplates = useMemo(() => {
    ...
    return [...LIBRARY_TEMPLATES, ...customTemplates];
  }, [savedTemplates]);
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      const libraryData = await fetchLibraryDataFromSupabase({
