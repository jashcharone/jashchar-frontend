  ...
  super_admin: [
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Admission Form Settings', path: ROUTES.SUPER_ADMIN.ADMISSION_FORM_SETTINGS },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Fee Structures', path: ROUTES.SUPER_ADMIN.FEE_STRUCTURES },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Room Management', path: ROUTES.SUPER_ADMIN.ROOM_MANAGEMENT },
        ...
        { title: 'Marks Entry (New)', path: ROUTES.SUPER_ADMIN.MARKS_ENTRY_NEW },
        ...
        { title: 'Moderation Engine', path: ROUTES.SUPER_ADMIN.MODERATION_ENGINE },
        ...
        { title: 'Bulk Document Generator', path: ROUTES.SUPER_ADMIN.BULK_DOCUMENT_GENERATOR },
        // -- Analytics & Online --
        ...
        { title: 'Subject Weightage', path: ROUTES.SUPER_ADMIN.SUBJECT_WEIGHTAGE },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Academic Setup', path: ROUTES.SUPER_ADMIN.ACADEMIC_SETUP },
    ...
    },
     {
      ...
      submenu: [
        ...
        { title: 'Interviews', path: ROUTES.SUPER_ADMIN.HR_INTERVIEWS },
        // -- Onboarding --
        ...
        { title: 'Salary Structure', path: ROUTES.SUPER_ADMIN.HR_SALARY_STRUCTURE },
        { title: 'Payroll Run', path: ROUTES.SUPER_ADMIN.HR_PAYROLL_RUN },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Categories', path: ROUTES.SUPER_ADMIN.TASK_CATEGORIES },
        ...
        { title: 'Automation', path: '/super-admin/task-management/automation-rules' },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Drivers', path: ROUTES.SUPER_ADMIN.TRANSPORT_DRIVERS },
        // -- Assignment & Fees --
        ...
        { title: 'Incident Management', path: ROUTES.SUPER_ADMIN.TRANSPORT_INCIDENTS },
        // -- Tracking & Safety --
        { title: '-- Tracking & Safety --', path: '#tr-tracking', disabled: true },
        { title: 'Live Tracking', path: ROUTES.SUPER_ADMIN.TRANSPORT_LIVE_TRACKING },
        { title: 'Geofencing', path: ROUTES.SUPER_ADMIN.TRANSPORT_GEOFENCING },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Mess Dashboard', path: ROUTES.SUPER_ADMIN.HOSTEL_MESS_MANAGEMENT },
        ...
        { title: 'Assets', path: ROUTES.SUPER_ADMIN.HOSTEL_ASSETS },
        ...
        { title: 'Security Dashboard', path: ROUTES.SUPER_ADMIN.HOSTEL_SECURITY_DASHBOARD },
        ...
        { title: 'Attendance Anomalies', path: ROUTES.SUPER_ADMIN.HOSTEL_ATTENDANCE_ANOMALIES },
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Branch Settings', path: ROUTES.SUPER_ADMIN.MULTI_BRANCH_SETTINGS },
    ...
    },
    {
    ...
    },
     {
      ...
      submenu: [
          ...
          { title: 'Custom Builder', path: ROUTES.SUPER_ADMIN.REPORTS_CUSTOM_BUILDER },
      ]
    },
    {
  ...
  accountant: [
    { title: 'Dashboard', icon: LayoutDashboard, path: ROUTES.ACCOUNTANT.DASHBOARD },
    {
      ...
      submenu: [
        ...
        { title: 'Fee Structures', path: ROUTES.ACCOUNTANT.FEE_STRUCTURES },
        ...
        { title: 'Fee Calendar', path: ROUTES.ACCOUNTANT.FEE_CALENDAR, badge: 'NEW' },
      ]
    },
    {
      title: 'Income',
  ...
  cashier: [
    ...
    },
    {
      ...
      submenu: [
        ...
        { title: 'Fee Calendar', path: ROUTES.CASHIER.FEE_CALENDAR, badge: 'NEW' },
      ]
    },
    {
      title: 'Finance',
  ...
  hostel_warden: [
    { title: 'Dashboard', icon: LayoutDashboard, path: ROUTES.HOSTEL_WARDEN.DASHBOARD },
    {
      ...
      submenu: [
        ...
        { title: 'Mess Dashboard', path: ROUTES.HOSTEL_WARDEN.HOSTEL_MESS_MANAGEMENT },
        ...
        { title: 'Assets', path: ROUTES.HOSTEL_WARDEN.HOSTEL_ASSETS },
