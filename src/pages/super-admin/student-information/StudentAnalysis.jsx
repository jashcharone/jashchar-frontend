...
const StudentAnalysis = () => {
  ...
  const handlePrint = () => {
    ...
    printWindow.document.write(`
      ...
      <p><strong>School:</strong> ${selectedBranch?.name || ''} | <strong>Session:</strong> ${sessions.find(s => s.id === selectedSessionId)?.name || 'Active'} | <strong>Generated:</strong> ${format(new Date(), 'dd MMM yyyy, hh:mm a')}</p>
      ...
      <div class="stats-grid">
        ...
        <div class="stat-box"><div class="stat-value" style="color:green">₹${feesOverview.totalPaid.toLocaleString('en-IN')}</div><div class="stat-label">Total Paid</div></div>
        <div class="stat-box"><div class="stat-value" style="color:red">₹${feesOverview.totalDue.toLocaleString('en-IN')}</div><div class="stat-label">Total Due</div></div>
