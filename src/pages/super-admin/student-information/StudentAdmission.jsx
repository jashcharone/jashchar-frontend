...
const StudentAdmission = () => {
  ...
  const validateFullForm = useCallback(() => {
    ...
    const fieldNameMap = {
      ...
      'mobile_no': 'mobile_no',        // Ensure mobile_no maps correctly
    };
    ...
    const autoGeneratedFields = [
      'username',           // Auto-set from admission_no (school_code)
    ...
    return valid;
  }, [formData, customFieldValues, allFields, pincode, rollNumberError, studentEmailError, fatherEmailError, aadharError, masterDocuments, studentUsernameError, parentUsernameError, feeGroups, schoolSettings]);
  ...
  const generateNextId = useCallback(async (settings, branchIdParam) => {
    ...
    if (!settings?.student_admission_no_auto_generation) {
      return null;
    }
